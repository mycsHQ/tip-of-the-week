This tip is about bootstraping vim editor as you main IDE. Although it looks scary at the start with a few plugins you could
turn the standard vim editor into a more user friendly IDE.

I would like to introduce a website which would help with the setting up of a custom .vimrc file

The website below basically gives you options of the supported languages you would want your config file to include 

`http://www.vim-bootstrap.com/`

After selecting your options and clicking on generate the webside will download the config file to your computer.
...
Installing is half the battle but it only get easy if you use it everyday 
